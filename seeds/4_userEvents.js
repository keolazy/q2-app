      ...
      return knex('users_events').insert([
        {
          user_id:8,
          event_id:1,
          questions:'1. So what is a blood feast? \
          2. Has anyone even seen a cannibal before? \
          3. What do people taste like?',
          topics:'I like sports, women, cars, \
          fire, pole-dancing, skydiving, bungie jumping \
          gambling, and crochet. ',
          job_status:'I\'m currrently between jobs.',
          noise_level:' It\'ll be hard to hear over the \
          sound of all that chomping!',
          where_to_find:'you can find me right in the action \
          I\ll probably have a bite myself!',
          ask_me:'Ask me about my weiner',
          personality:'I\'m a deeply sensitive man. I don\'t like jokes \
          pointed directly at me, and I don\t understand sarcasm.'
        },{
          user_id:1,
          event_id:2,
          questions:'1. Who in the fuck is Lupe Fiasco? \
          ...
          ask_me:'ask me where I\'ve been traveling, how much my house costs, \
          ...
          user_id:5,
          event_id:1,
          questions:'1. seriously, how much wood could a wood chuck chuck if \
          a wood chuck could chuck wood!?',
          topics:'astonomy, astrology',
          job_status:'CPA accountant at Price Waterhouse',
          noise_level:'Motorhead, My Bloody Valentine, Jesus and Mary Chain loud',
          where_to_find:'in the bathroom',
          ask_me:'about your taxes',
          personality:'nicest guy ever, just obsessed with the phrase "stack house"',
        }, {
          user_id:6,
          event_id:1,
